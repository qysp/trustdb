...
class Collection extends EventEmitter {
  ...
  /**
   * Clean the collection from invalid documents using the registered schema.
   *
   * @returns {object[]} Removed documents.
   */
  cleanWithSchema() {
    ...
    return this.remove((doc) => !this._schema.validate(doc));
  }

  /**
   * Validate a document for the collection using the registered schema.
   *
  ...
  testDocument(document) {
    ...
    return this._schema.validate(document);
  }
