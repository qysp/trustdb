...
class Ezstore extends EzeventEmitter {
   ...
   * @param {boolean} [settings.restoreSettings] restores settings from the loaded database (overwrites new settings!)
  ...
  configureSettings(settings) {
    ...
    if (settings.hasOwnProperty('restoreSettings') &&
        typeof settings.autosaveInterval === 'boolean') {
      this.restoreSettings = settings.autosaveInterval;
    }
